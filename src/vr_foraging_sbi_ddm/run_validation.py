...
def run_validation_suite(model_path, n_sbc_tests=100, n_recovery_tests=10, seed=42):
    ...
    print("\nGenerated files:")
    print("  - sbc_results.png          (SBC diagnostic plots)")
    print("  - sbc_results.pkl          (SBC data)")
    print("  - parameter_recovery.png   (Recovery scatter plots)")
    print("  - recovery_results.pkl     (Recovery data)")
    print("\n" + "=" * 80)
...
def main():
    ...
    run_validation_suite(model_path=model_path, n_sbc_tests=100, n_recovery_tests=10, seed=42)
